...
\begin{document}
  ...
  \subsection{Array II}
    ...
    \begin{figure}[H]
      \begin{floatrow}
        \ffigbox{
          \includegraphics[scale=0.45]{InsertionSort.pdf}
        }{
        ...
        \begin{tabular}{cc}
          ...
          100        & 291000             \\
          1000       & 3734000            \\
          10000      & 45673000           \\ \hline
        \end{tabular}
        }{
          \caption{InsertionsSort's data.}
        }
      \end{floatrow}
    \end{figure}
    ...
    \begin{figure}[H]
      \begin{floatrow}
        \ffigbox{
          \includegraphics[scale=0.45]{MergeSort.pdf}
        }{
        ...
        \begin{tabular}{cc}
          ...
          100 & 445000 \\
          1000	& 47573000 \\
          10000	& 4655923000 \\ \hline
        \end{tabular}
        }{
          \caption{MergeSort's data.}
        }
      \end{floatrow}
    \end{figure}
