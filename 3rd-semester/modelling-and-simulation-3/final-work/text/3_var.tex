...
% Table \ref{tab:endo} shows whether a variable is a endogenous or exogenous.
% \begin{table}[H]
% \centering
% \caption{Endogenous and exogenous variables.}
% \label{tab:endo}
% \begin{tabular}{ccc}
% \hline
% \textbf{Variable} & \textbf{Endogenous} & \textbf{Exogenous} \\ \hline
% CC Price          & $\times$            &                    \\
% CC bought         & $\times$            &                    \\
% CC sold           & $\times$            &                    \\
% Investors         & $\times$            &                    \\
...
% Earnings          & $\times$            &                    \\
% Exchange fees     & $\times$            &                    \\
% Government taxes  &                     & $\times$           \\
% Growth rate       & $\times$            &                    \\ \hline
% \end{tabular}
% \end{table}

% \subsection{Changes to variables}
% \subsubsection{Added}
% \begin{itemize}
% \item Growth rate: It refers to the percentage change of a price within a time of an specific cryptocurrency \cite{GR}. Measurement units: \%. This variable was included because, with the new definition of the problem, this is the main variable to regulate.
% \end{itemize}
% \subsubsection{Removed}
% \begin{itemize}
% \item CC Produced \& CC Mined: These variables do not affect the system dynamics in an essential way, since they are already taken into account in the Price variable; it is important to mention both variables were similar and did not represent big changes to our dynamic hypothesis.
% \end{itemize}
