...
\input{text/1_intro}
\input{text/2_theories}
\input{text/3_var}
\input{text/4_system}
\input{text/5_dynamic}
\input{text/6_flux}
\input{text/7_validation}
\input{text/8_poli}
%Bibs
